...
export const tetromino = {
    ...
    rotateTetromino(direction) {
        ...
        if (willTouchLimits || (isAtRightEdge && isAtLeftEdge)) {
            console.log('rotation not possible due to boundaries conflict');
        } else {
    ...
    moveLeft() {
        ...
        if (!isAtLeftEdge && !this.lateralBlock('left')) {
            ...
            console.log('left boundary prevents tetromino movement');
        }
    },
    pushDown() {
        ...
        if (!this.freeze() && this.canMoveDown) {
            ...
            console.log('bottom boundary prevents tetromino movement');
        }
    },
    moveRight() {
        ...
        if (!isAtRightEdge && !this.lateralBlock('right')) {
            ...
            console.log('right boundary prevents tetromino movement');
        }
    },
    // when the current tetromino encounters a boundary it will freeze and become part of the boundaries.
    freeze() {
